...
class AppLocalizations {
  ...
  static const Map<String, Map<String, String>> _localizedValues = {
    'ar': {
      ...
      'batchDownloadCanceled': 'تم إلغاء التنزيل الجماعي',
      'deletedOfflineFiles': 'تم حذف الملفات',
      'cancelBatchDownload': 'إلغاء التنزيل',
      'currentDownloadingSurah': 'السورة الحالية',
      'currentSurahProgress': 'تقدم السورة',
      ...
      'searchDownloadedFiles': 'ابحث داخل الملفات المنزلة',
      'noMatchingDownloads': 'لا توجد ملفات مطابقة للبحث',
      'deleteFile': 'حذف الملف',
      'readingSettings': 'إعدادات القراءة',
      'translation': 'الترجمة',
      'tafsir': 'التفسير',
      'tafsirUnavailableOffline': 'التفسير غير متاح حاليا بدون اتصال.',
    ...
    'en': {
      ...
      'batchDownloadCanceled': 'Batch download canceled',
      'deletedOfflineFiles': 'Deleted files',
      'cancelBatchDownload': 'Cancel download',
      'currentDownloadingSurah': 'Current surah',
      'currentSurahProgress': 'Current surah progress',
      ...
      'searchDownloadedFiles': 'Search downloaded files',
      'noMatchingDownloads': 'No matching downloads',
      'deleteFile': 'Delete file',
      'readingSettings': 'Reading settings',
      'translation': 'Translation',
      'tafsir': 'Tafsir',
      'tafsirUnavailableOffline': 'Tafsir is currently unavailable offline.',
    ...
    'fr': {
      ...
      'batchDownloadCanceled': 'Telechargement groupe annule',
      'deletedOfflineFiles': 'Fichiers supprimes',
      'cancelBatchDownload': 'Annuler le telechargement',
      'currentDownloadingSurah': 'Sourate en cours',
      'currentSurahProgress': 'Progression de la sourate',
      ...
      'searchDownloadedFiles': 'Rechercher dans les fichiers telecharges',
      'noMatchingDownloads': 'Aucun fichier correspondant a la recherche',
      'deleteFile': 'Supprimer le fichier',
      'readingSettings': 'Parametres de lecture',
      'translation': 'Traduction',
      'tafsir': 'Tafsir',
      'tafsirUnavailableOffline':
          'Le tafsir n est pas disponible hors ligne pour le moment.',
      'addBookmark': 'Ajouter un signet',
      'copyAyah': 'Copier le verset',
      'ayahCopied': 'Verset copie',
      ...
      'sleep20m': '20 min',
      'sleep30m': '30 min',
      'cancelSleepTimer': 'Annuler le minuteur',
    },
  };
